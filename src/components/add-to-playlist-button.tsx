...
import { useLikeTrack, useUnlikeTrack, useIsTrackLiked } from "@/hooks/useLikedSongs"
...
export function AddToPlaylistButton({ 
  ...
  const unlikeTrackMutation = useUnlikeTrack()
  ...
  const handleToggleLike = async () => {
    try {
      if (isLiked) {
        await unlikeTrackMutation.mutateAsync(trackId)
      } else {
